...
```
    ...
    ## 1           1     0.916          8.31 -0.00279 0.994       NA   
    ## 2           2     0.894          8.44  0.00257 0.988       -5.97
    ## 3           3     0.907          8.05  0.00470 1.01        -5.35
    ## 4           4     0.930          7.66 -0.00554 1.04        NA   
    ## 5           5     0.921          8.17 -0.00844 1.01        NA   
    ## 6           6     0.917          7.90  0.00423 1.02        -5.45
...
```
    ...
    ## Warning: Removed 3419 rows containing non-finite values (`stat_bin()`).
...
| log_product   |   -8.975 |   -4.622 |

- The 95% CI for $\hat{r}^2$ is (0.889, 0.941)
- The 95% CI for $\log(\hat{\beta}_1 \times \hat{\beta}_2)$ is (-8.975,
  -4.622)
...
![](p8105_hw6_jy3360_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
